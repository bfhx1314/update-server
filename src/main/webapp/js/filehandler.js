...
//	filename = unescape(filename);
	...
	if (option==0) {	// rename
		...
		fieldObj.setAttribute("name","sourcePath");
		fieldObj.setAttribute("value",filePath);
		fieldObj.setAttribute("id","sourcePath");
		document.getElementById("modal-field").appendChild(fieldObj);
...
//		post('deleteFile.do', {'sourcePath':filePath}); 
		...
		var textObj = document.createElement("a");
		textObj.innerText = "Are you sure you want to delete this file?\n" + "\""+filename+"\"";
		textObj.textContent = "Are you sure you want to delete this file?\n" + "\""+filename+"\"";
		document.getElementById("modal-text").appendChild(textObj);
		
		var fieldObj = document.createElement("input");
		fieldObj.setAttribute("type","hidden");
		fieldObj.setAttribute("name","deleteFile");
		fieldObj.setAttribute("value",filename);
		document.getElementById("modal-field").appendChild(fieldObj);
...
//             '</div>',
      ...
      template: 
    	  '<div class="qq-upload-button limn-upload-file">'+
    	  '上传</div>' +
    	  
    	  '<div style="display:none" class="limn-upload-file"></div>'+
    	  '<ul class="qq-upload-list limn-upload-file"></ul>' + 
    	  '</div>',
