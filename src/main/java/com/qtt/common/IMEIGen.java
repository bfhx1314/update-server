...
//        String code = "8623370303523";
//        String newCode = genCode(code);
//        System.out.println("======"+newCode);
//        System.out.println(code+newCode);
//        String endCode = "86233703302087";
//        beachIMEI(code,endCode);
        System.out.println(IMEIGen.getGen());
    }
    ...
    public static String getGen(){
        ...
        int index = RandomData.getNumberRange(0,3);

        String code = args[index] + RandomData.getNumberRange(123456,987654);

        return code + genCode(code);
